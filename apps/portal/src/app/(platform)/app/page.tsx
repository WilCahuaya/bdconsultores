...
export default async function PlatformHomePage() {
  ...
  const inventarios = webAppById("inventarios");
  const planillas = webAppById("planillas");
  const inventarioHref = `${inventarios.basePath}${inventarioHomePathForRole(profile.rol)}`;
        ...
        <li>
          ...
          >
            ...
            <p className="mt-auto pt-2 text-sm text-foreground/80">
              Contratos, documentos, T-Registro y planilla mensual. Aún en construcción.
            </p>
          </a>
        </li>
      </ul>
