      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            30 días por año de servicio. Controle el goce del periodo y registre las fechas en la ficha.
          </p>
        </div>
        ...
        {entidades.length === 0 ? (
          ...
          <>
            ...
            {canWrite ? (
              <p className="text-sm text-muted-foreground">
                Entre a la ficha para registrar el goce (fechas, días y si está programado o ya gozado).
              </p>
            ) : null}
          </>
        )}
